...
const { patchCertificationController } = require("../../controllers/certifications/patchControllers");
...
const patchCertificationHandler=async(req, res)=>{
    ...
    try {
        ...
        if(isUUID(id)){
            if(data){
                const updateCertification=await patchCertificationController(id, data);
